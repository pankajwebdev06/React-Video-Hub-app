        ...
        <Stack direction={['column', 'row']} h={'100vh'} >
            ...
            <VStack w={'full'} >
                ...
                <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowX={'auto'} >
                    ...
                    <Text>This is a Sammple video for testing and demo, this is called description. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fuga officiis reiciendis sapiente nisi sed consequatur est consequuntur</Text>
                </VStack>
            </VStack>
